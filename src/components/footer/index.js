    ...
    <FooterContainer>
      <div className='footer-top'>
        <div className='footer-left'>
          ...
          <p>
            Blushawk delivers innovative solutions for businesses to thrive in today’s market. Our expertise ensures
            unparalleled results, empowering growth and success.
          </p>
        </div>
