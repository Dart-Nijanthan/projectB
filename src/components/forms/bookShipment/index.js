...
import { Form, Input, Button, Row, Col, Typography, Select, InputNumber } from 'antd';
      ...
      >
        ...
        <Form layout='vertical' onFinish={onFinish} style={{ maxWidth: '600px', margin: 'auto' }}>
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} md={12}>
              <Form.Item label='City' name='fromCity' rules={[{ required: true, message: 'Please enter the city!' }]}>
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} md={12}>
              <Form.Item label='City' name='toCity' rules={[{ required: true, message: 'Please enter the city!' }]}>
                <Input placeholder='Enter city' />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={12}>
              <Form.Item label='State' name='toState' rules={[{ required: true, message: 'Please enter the state!' }]}>
                <Input placeholder='Enter state' />
              </Form.Item>
            </Col>
            <Col xs={24} md={12}>
